...
% Considerem per a \( c \in (0,1) \) una contracció de l'adherència d'\( R \), \( c\bar{R}
% \). És clar que \( c\bar{R} \subseteq R \). En concret podem prendre la successió \( R_k =
% (1 - \frac{1}{k})\bar{R}\). Aleshores és clar que \( R_k \subseteq R_{k+1} \) i que
% \begin{equation*}
% 	\bigcup_{k = 0}^{\infty} R_k = R.
% \end{equation*}
% En particular
% \begin{equation*}
% 	\bigcup_{k = 0}^{\infty} (R_k \cap A) = (R \cap A) = R.
% \end{equation*}
% A més 
% \begin{equation*}
% 	m(R_k) = \left(1 - \frac{1}{k}\right)^n v(\bar{R}) = \left(1 - \frac{1}{k}\right)^n v(R) > 0
% \end{equation*}
% i com que els \( R_k \) són compactes per ser tancats i fitats tenim \( A \cap R_k \neq
% \emptyset \).

% Considerem per a \( n \geq 1 \) una contracció de l'adherència de \( R \), \( (1 -
% \frac{1}{n})\bar{R} \)


% Per tant hi ha un recobriment d'\( A \) per rectangles oberts, \( \{ R_n \}_{n =
% 0}^{\infty} \) tal que
% \begin{equation*}
% 	\sum_{n = 0}^{\infty} v(R_n) \leq R.
% \end{equation*}
% D'aquí se segueix que
% \begin{equation*}
% 	\bigcup_{n = 0}^{\infty} R_n \subseteq R.
% \end{equation*}


% Sigui \( \bar{R} \) l'adherència del rectangle \( R \) i considerem per a \( 0 < c < 1 \)
% una contracció de \( \bar{R} \), \( c\bar{R} \). Sigui \( K \subseteq c\bar{R} \subseteq R
% \) un compacte. Aleshores, per hipòtesi \( A \cap K \neq \emptyset \). D'altra banda 
